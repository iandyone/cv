...
if (!embedimSnow) {
    ...
    for (i = 1; i < 200; i++) {
        ...
        let rndO = embRand(-100000, 100000) * 0.0001;
        let rndT = (embRand(3, 8) * 10).toFixed(2);
        let rndS = (embRand(0, 10000) * 0.0001).toFixed(2);
